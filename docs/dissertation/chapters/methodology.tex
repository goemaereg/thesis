...
\begin{itemize}
    ...
    \item \textbf{TN}: A true negative is every part of the image for whicch we don't have a ground truth bounding box, and where we did not predict an object. This metric is not useful for object localization, hence we ignore it by setting it to zero.
\end{itemize}
