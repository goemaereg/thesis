...
from .cellsX import CCellX, CCellMX, CCellPX, RCellX, CCellTX,CCellTsX
from .random_generator_baseclass import RandomFetcher
from .random_simple_generator_metasettings import *
...
class SimpleRandomFetcher(RandomFetcher):
    ...
    def setup0001(self, general_meta_setting, explanation_setting, background_setting=None, s=None):
        ...
        self.obj2d.change_array_shape(self.s)
